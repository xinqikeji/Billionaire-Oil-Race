    ...
    public partial class LiquidVolume : MonoBehaviour {
        ...
        internal static void SetupBackFacesBuffer(Renderer renderer) {
            ...
            if (LiquidVolume.useFPRenderTextures) {
                buf.GetTemporaryRT(backBufferID, -1, -1, 24, FilterMode.Point, RenderTextureFormat.Default, RenderTextureReadWrite.Linear);
        ...
        internal static void SetupFrontFacesBuffer(Renderer renderer) {
            ...
            if (useFPRenderTextures) {
                buf.GetTemporaryRT(frontBufferID, -1, -1, 24, FilterMode.Point, RenderTextureFormat.Default, RenderTextureReadWrite.Linear);
