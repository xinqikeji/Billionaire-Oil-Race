	...
	namespace Runtime
	{
		...
		public class TCP2_PlanarReflection : MonoBehaviour
		{
			...
			void UpdateRenderTexture()
			{
				...
				reflectionRenderTexture = new RenderTexture(textureSize, textureSize, 16, renderTextureFormat, RenderTextureReadWrite.Default);
...
#endif
				{
					if (applyBlur && useBlurDepth)
					{
						...
						if (reflectionDepthRenderTexture == null)
						{
                            ...
                            reflectionDepthRenderTexture = new RenderTexture(textureSize, textureSize, 16, RenderTextureFormat.Default, RenderTextureReadWrite.Linear);
